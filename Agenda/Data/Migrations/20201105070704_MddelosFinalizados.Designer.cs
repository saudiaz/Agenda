...
namespace Agenda.Data.Migrations
{
    ...
    [Migration("20201105070704_MddelosFinalizados")]
    partial class MddelosFinalizados
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agenda.Models.CompaniaTelefonica", b =>
                {
            ...
            modelBuilder.Entity("Agenda.Models.Perfil", b =>
                {
                    b.HasOne("Agenda.Models.CompaniaTelefonica", "CompaniaTelefonicas")
                        .WithOne("Perfil")
                        .HasForeignKey("Agenda.Models.Perfil", "IDCompaniaTelefonica")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Agenda.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Perfil")
                        .HasForeignKey("Agenda.Models.Perfil", "IdUser");
                });
